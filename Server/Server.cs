...
namespace Server
{
    ...
    class Server
    {
        ...
        {
            Console.Title = "Vercetti Online 0.1 Server";
            Console.WriteLine("Vercetti Online 0.1 Server - Alpha Build");
            Console.WriteLine("============================================");
        ...
        {
            if (server.ConnectedPeersCount < 10) request.AcceptIfKey("VERCETTI ONLINE"); else request.Reject();
        }
